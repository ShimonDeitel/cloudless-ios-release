...
enum Reminders {
    private static let identifier = "cloudless.daily.reminder"
    ...
    static func schedule(hour: Int, minute: Int) {
        ...
        content.title = "Name today's worry"
        content.body = "Write your worry, put it on a cloud, and let it drift away."
